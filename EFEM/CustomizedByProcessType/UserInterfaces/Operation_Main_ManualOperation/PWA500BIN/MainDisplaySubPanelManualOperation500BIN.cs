    ...
    public partial class MainDisplaySubPanelManualOperation500BIN : ParameterPanel
    {
        ...
        public MainDisplaySubPanelManualOperation500BIN(string name)
        {
            ...
            OperationButtons = new Dictionary<PanelMode, Sys3Controls.Sys3button>
            {
                ...
                //{ PanelMode.Parallel_IO, btnManualOperationPIO },
            };

            if (FrameOfSystem3.Work.AppConfigManager.Instance.InterfaceTypePIO == Define.DefineEnumProject.AppConfig.EN_PIO_INTERFACE_TYPE.E84)
            {
                panelParallelIOE84 = new MainDisplaySubPanelParallelIOE84
                {
                    Dock = DockStyle.Fill
                };

                panelParallelIOE84.Hide();
                pnManualOperation.Controls.Add(panelParallelIOE84);
                OperationButtons[PanelMode.Parallel_IO] = btnManualOperationPIO;
            }
            else
            {
                btnManualOperationPIO.Visible = false;
            }
        ...
        private readonly MainDisplaySubPanelParallelIOE84 panelParallelIOE84 = null;
        ...
        private void DisplaySubPanel()
        {
            ...
            switch (_selectedPanels)
            {
                ...
                case PanelMode.Editor:
                    ...
                    break;
                case PanelMode.Parallel_IO:
                    _selectedPanel = panelParallelIOE84;
                    break;
                default:
                    break;
            }
