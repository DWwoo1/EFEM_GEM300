...
namespace EFEM.CustomizedByProcessType.PWA500Common
{
    ...
    public class FormattedRecipeParser
    {
        ...
        /// Data를 받아 파싱합니다.
        /// </summary>
        public string ConvertForSendToPM(Dictionary<string, string> data)
        {
            return BuildRecipeText(data);
        }

        /// <summary>
        /// Data를 받아 파싱합니다.
        /// </summary>
        public Dictionary<string, string> ConvertForSendToHost(string[] data)
        {
            return ParseRecipeLines(data);
        }

        /// <summary>
        /// 파일 경로를 받아 파싱합니다.
        /// </summary>
        public Dictionary<string, string> ConvertForSendToHost(string filePath)
        {
            var lines = File.ReadAllLines(filePath);
            return ParseRecipeLines(lines);
        }
        #endregion </External>
