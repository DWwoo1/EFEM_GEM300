...
namespace EFEM.CustomizedByProcessType.PWA500Common
{
    ...
    public class ScenarioFormattedRecipeHandlingRequestParamValues : ScenarioParamValues
    {
        public ScenarioFormattedRecipeHandlingRequestParamValues(List<string> values, /*bool useEventHandling,*/ WaferMapData mapData) : base(values)
        {
    ...
    public class ScenarioFormattedRecipeHandlingRequest : AutoScenarioBase
    {
        #region <Constructor>
        public ScenarioFormattedRecipeHandlingRequest(string name, long streamToSend, long funcToSend, bool useRemoteCommandConfirmation, uint timeOut = 10000)
            : base(name, timeOut)
        {
        ...
        #region <Fields>
        ScenarioFormattedRecipeHandlingRequestParamValues _paramValue = null;
        ...
        {
            _paramValue = paramValues as ScenarioFormattedRecipeHandlingRequestParamValues;
        }
        ...
        private bool SendSecsMessageReqMapDownload()
        {
            ...
            if (!(_paramValue is ScenarioFormattedRecipeHandlingRequestParamValues value))
                return false;
