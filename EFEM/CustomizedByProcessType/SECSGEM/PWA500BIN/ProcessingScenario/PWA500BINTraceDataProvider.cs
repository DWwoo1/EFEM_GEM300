...
namespace EFEM.CustomizedByProcessType.PWA500BIN
{
    ...
    public sealed class PWA500BINTraceDataProvider : ITraceDataProvider, IDetachingTraceParameterProvider
    {
        ...
        public PWA500BINTraceDataProvider(
            AnalogIO analogIO,
        ...
        private void BuildTraceMaps()
        {
            ...
            _analogInfo = new Dictionary<long, int>
            {
                ...
                [1707] = (int)EN_ANALOG_IN.IONIZER_4
            };
        }
        private void BuildDefaultExternalTraceMaps()
        {
            _traceDataForExternal = new ConcurrentDictionary<string, string>
            {
                ...
                [EN_SVID_LIST.SUPPLY_PITCH_WAFER_ID.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_TOP_X.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_TOP_Y.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_TOP_X.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_TOP_Y.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_BOTTOM_X.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_BOTTOM_Y.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_BOTTOM_X.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_BOTTOM_Y.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_CENTER_X.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_CENTER_Y.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_AVERAGE_X.ToString()] = string.Empty,
                [EN_SVID_LIST.SUPPLY_PITCH_AVERAGE_Y.ToString()] = string.Empty,
            };
            ...
            _traceDataByName = new Dictionary<string, long>
            {
                ...
                [EN_SVID_LIST.SUPPLY_PITCH_WAFER_ID.ToString()] = 2400,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_TOP_X.ToString()] = 2401,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_TOP_Y.ToString()] = 2402,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_TOP_X.ToString()] = 2403,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_TOP_Y.ToString()] = 2404,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_BOTTOM_X.ToString()] = 2405,
                [EN_SVID_LIST.SUPPLY_PITCH_LEFT_BOTTOM_Y.ToString()] = 2406,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_BOTTOM_X.ToString()] = 2407,
                [EN_SVID_LIST.SUPPLY_PITCH_RIGHT_BOTTOM_Y.ToString()] = 2408,
                [EN_SVID_LIST.SUPPLY_PITCH_CENTER_X.ToString()] = 2409,
                [EN_SVID_LIST.SUPPLY_PITCH_CENTER_Y.ToString()] = 2410,
                [EN_SVID_LIST.SUPPLY_PITCH_AVERAGE_X.ToString()] = 2411,
                [EN_SVID_LIST.SUPPLY_PITCH_AVERAGE_Y.ToString()] = 2412,
            };
