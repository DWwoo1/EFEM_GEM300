...
namespace FrameOfSystem3.SECSGEM.Scenario
{
    public class ProcessingScenarioPWA500BIN_TP : ProcessingScenario
    {
        ...
        private PWA500BINTraceDataProvider _traceDataProvider = null;
        ...
        private static readonly string[] PbiWorkResultKeys =
        {
            PBIDataKeys.KeyPickUpWaferID,
            PBIDataKeys.KeyPickIndexX,
            PBIDataKeys.KeyPickIndexY,
            PBIDataKeys.KeyWaferVisionX,
            PBIDataKeys.KeyWaferVisionY,
            PBIDataKeys.KeyWaferVisionT,
            PBIDataKeys.KeyToolNum,
            PBIDataKeys.KeyPickUpForce,
            PBIDataKeys.KeyULCResultX,
            PBIDataKeys.KeyULCResultY,
            PBIDataKeys.KeyULCResultT,
            PBIDataKeys.KeySortingWaferID,
            PBIDataKeys.KeySortingIndexX,
            PBIDataKeys.KeySortingIndexY,
            PBIDataKeys.KeyPlaceForce,

            PBIDataKeys.KeyGap_LeftTop_X,
            PBIDataKeys.KeyGap_LeftBottom_X,
            PBIDataKeys.KeyGap_RightTop_X,
            PBIDataKeys.KeyGap_RightBottom_X,
            PBIDataKeys.KeyGap_LeftTop_Y,
            PBIDataKeys.KeyGap_LeftBottom_Y,
            PBIDataKeys.KeyGap_RightTop_Y,
            PBIDataKeys.KeyGap_RightBottom_Y,
        };

        private static readonly string[] PbiWorkResultDefaultValues =
        {
            nameof(EN_SVID_LIST.PBI_CORE_WAFER_ID),
            nameof(EN_SVID_LIST.PBI_PICK_INDEX_X),
            nameof(EN_SVID_LIST.PBI_PICK_INDEX_Y),
            nameof(EN_SVID_LIST.PBI_WAFER_VISION_X),
            nameof(EN_SVID_LIST.PBI_WAFER_VISION_Y),
            nameof(EN_SVID_LIST.PBI_WAFER_VISION_T),
            nameof(EN_SVID_LIST.PBI_TOOL_NUM),
            nameof(EN_SVID_LIST.PBI_PICK_UP_FORCE),
            nameof(EN_SVID_LIST.PBI_ULC_RESULT_X),
            nameof(EN_SVID_LIST.PBI_ULC_RESULT_Y),
            nameof(EN_SVID_LIST.PBI_ULC_RESULT_T),
            nameof(EN_SVID_LIST.PBI_SORTING_WAFER_ID),
            nameof(EN_SVID_LIST.PBI_SORTING_INDEX_X),
            nameof(EN_SVID_LIST.PBI_SORTING_INDEX_Y),
            nameof(EN_SVID_LIST.PBI_PLACE_FORCE),

            nameof(EN_SVID_LIST.PBI_GAP_LEFT_TOP_X),
            nameof(EN_SVID_LIST.PBI_GAP_LEFT_BOTTOM_X),
            nameof(EN_SVID_LIST.PBI_GAP_RIGHT_TOP_X),
            nameof(EN_SVID_LIST.PBI_GAP_RIGHT_BOTTOM_X),
            nameof(EN_SVID_LIST.PBI_GAP_LEFT_TOP_Y),
            nameof(EN_SVID_LIST.PBI_GAP_LEFT_BOTTOM_Y),
            nameof(EN_SVID_LIST.PBI_GAP_RIGHT_TOP_Y),
            nameof(EN_SVID_LIST.PBI_GAP_RIGHT_BOTTOM_Y),
        };

        private static readonly Dictionary<string, int> PbiWorkResultIndexByKey =
            CreatePbiWorkResultIndexByKey();

        private readonly string[] _pbiWorkResultValues = new string[PbiWorkResultKeys.Length];
            ...
            foreach (EN_SCENARIO scenario in Enum.GetValues(typeof(EN_SCENARIO)))
            {
                ...
                switch (scenario)
                {
                    ...
                    case EN_SCENARIO.SCENARIO_PORT_STATUS_LOAD_6:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.PORT_STATUS_LOAD.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.PORT_STATUS_LOAD.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    ...
                    case EN_SCENARIO.SCENARIO_PORT_STATUS_UNLOAD_6:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.PORT_STATUS_UNLOAD.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.PORT_STATUS_UNLOAD.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_CARRIER_LOAD:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.CARRIER_LOAD.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.CARRIER_LOAD.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_CARRIER_UNLOAD:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.CARRIER_UNLOAD.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.CARRIER_UNLOAD.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_RFID_READ_CORE_1:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_CORE_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_CORE_1.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_RFID_READ_CORE_2:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_CORE_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_CORE_2.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_RFID_READ_EMPTY_TAPE:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_EMPTY_TAPE.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_EMPTY_TAPE.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_RFID_READ_BIN_1:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_BIN_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_BIN_1.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_RFID_READ_BIN_2:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_BIN_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_BIN_2.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_RFID_READ_BIN_3:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_BIN_3.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.RFID_READ_BIN_3.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_REQ_TRACK_IN:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_TRACK_IN.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_TRACK_IN.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_REQ_CORE_WAFER_TRACK_OUT:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_CORE_WAFER_TRACK_OUT.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_CORE_WAFER_TRACK_OUT.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_REQ_LOT_MATCH:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_LOT_MATCH.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_LOT_MATCH.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_REQ_BIN_WAFER_TRACK_OUT:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_BIN_WAFER_TRACK_OUT.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_BIN_WAFER_TRACK_OUT.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SLOT_WAFER_MAPPING_CORE_1:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_CORE_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_CORE_1.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SLOT_WAFER_MAPPING_CORE_2:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_CORE_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_CORE_2.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SLOT_WAFER_MAPPING_EMPTY_TAPE:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_EMPTY_TAPE.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_EMPTY_TAPE.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SLOT_WAFER_MAPPING_BIN_1:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_BIN_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_BIN_1.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SLOT_WAFER_MAPPING_BIN_2:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_BIN_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_BIN_2.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SLOT_WAFER_MAPPING_BIN_3:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_BIN_3.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SLOT_WAFER_MAPPING_BIN_3.ToString()].VariableIds,
                                true));
                        }
                        break;
                    ...
                    case EN_SCENARIO.SCENARIO_REQ_CORE_WAFER_SPLIT_LAST:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_CORE_WAFER_SPLIT_LAST.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_CORE_WAFER_SPLIT_LAST.ToString()].VariableIds,
                                true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_REQ_CORE_CHIP_MERGE:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_CORE_CHIP_MERGE.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_CORE_CHIP_MERGE.ToString()].VariableIds,
                                true));
                        }
                        break;                    
                    ...
                    case EN_SCENARIO.SCENARIO_CORE_WAFER_DETACH_END:
                        ...
                        break;
                    // 2026.06.22. jhlim [ADD] 신규 시나리오 추가(ADS 이동 플래그, 스크랩 빈/코어 칩, 작업 결과 업로드)
                    case EN_SCENARIO.SCENARIO_ADS_MOVE_FLAG_1:
                        {
                            ...
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.ADS_MOVE_FLAG_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.ADS_MOVE_FLAG_1.ToString()].VariableIds,
                                true, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_ADS_MOVE_FLAG_2:
                        {
                            ...
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.ADS_MOVE_FLAG_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.ADS_MOVE_FLAG_2.ToString()].VariableIds,
                                true, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SCRAP_BIN_CHIP:
                        {
                            ...
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SCRAP_BIN_CHIP.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SCRAP_BIN_CHIP.ToString()].VariableIds,
                                true, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_SCRAP_CORE_CHIP:
                        {
                            MakeScenario(scenario, new ScenarioScrapCoreChips(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.SCRAP_CORE_CHIP.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.SCRAP_CORE_CHIP.ToString()].VariableIds,
                                true, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_UPLOAD_WORK_RESULT:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.UPLOAD_WORK_RESULT.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.UPLOAD_WORK_RESULT.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    // 2026.06.22. jhlim [END]
                    case EN_SCENARIO.SCENARIO_BIN_WAFER_ID_READ:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.BIN_WAFER_ID_READ.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.BIN_WAFER_ID_READ.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_BIN_SORTING_START_1:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_START_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_START_1.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_BIN_SORTING_END_1:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_END_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_END_1.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_BIN_SORTING_START_2:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_START_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_START_2.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_BIN_SORTING_END_2:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_END_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_END_2.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_BIN_SORTING_START_3:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_START_3.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_START_3.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_BIN_SORTING_END_3:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_END_3.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.BIN_SORTING_END_3.ToString()].VariableIds,
                                false, 10000, true));
                        }
                        break;
                    ...
                    case EN_SCENARIO.SCENARIO_REQ_COLLET_CHANGE_1:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_COLLET_CHANGE_1.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_COLLET_CHANGE_1.ToString()].VariableIds,
                                true, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_REQ_COLLET_CHANGE_2:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_COLLET_CHANGE_2.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_COLLET_CHANGE_2.ToString()].VariableIds,
                                true, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_REQ_HOOD_CHANGE:
                        {
                            MakeScenario(scenario, new SendingEventScenario(scenario.ToString(),
                                CollectionEventList[EN_EVENT_LIST.REQ_HOOD_CHANGE.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.REQ_HOOD_CHANGE.ToString()].VariableIds,
                                true, 10000, true));
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_ASSIGN_SUBSTRATE_ID:
                        ...
                        break;
                    case EN_SCENARIO.SCENARIO_UPLOAD_BIN_SCRAP_INFO:
                        {
                            if (IsOldEvents)
                                break;
                            MakeScenario(scenario, new ClientToClientCommunicationScenario(scenario.ToString()));
                    ...
                    case EN_SCENARIO.SCENARIO_REQ_CORE_WAFER_ID:
                        {
                            MakeScenario(scenario, new ScenarioReqWaferIdAssign(
                                ObjectNames.CORE_WAFER_ID_RESULT.ToString(),
                                CollectionEventList[EN_EVENT_LIST.CORE_WAFER_ID_REQ.ToString()].Id,
                                CollectionEventList[EN_EVENT_LIST.CORE_WAFER_ID_REQ.ToString()].VariableIds,
                                -1,
                                null,
                                14, 3, true
                                ));
                    ...
                    case EN_SCENARIO.SCENARIO_REQ_RECIPE_DOWNLOAD:
                        {
                            MakeScenario(scenario, new EFEM.CustomizedByProcessType.PWA500Common.ScenarioRecipeHandlingRequest(scenario.ToString(),
                                false,
                    ...
                    case EN_SCENARIO.SCENARIO_PICK_UP_END:
                        {
                            if (CollectionEventList.TryGetValue(EN_EVENT_LIST.PICK_UP_END.ToString(), out CollectionEvent ceid))
                            {
                                MakeScenario(scenario, new SendingEventScenario(scenario.ToString(), ceid.Id, ceid.Variables.Keys.ToList(), false, 1000, false));
                            }
                        }
                        break;
                    case EN_SCENARIO.SCENARIO_PLACE_END:
                        {
                            if (CollectionEventList.TryGetValue(EN_EVENT_LIST.PLACE_END.ToString(), out CollectionEvent ceid))
                            {
                                MakeScenario(scenario, new SendingEventScenario(scenario.ToString(), ceid.Id, ceid.Variables.Keys.ToList(), false, 1000, false));
                            }
                        }
        ...
        {
            _traceDataProvider = new PWA500BINTraceDataProvider(
                _analogIO,
                _ffuManager);
        ...
        public override List<string> GetScenarioParameterList(EN_SCENARIO scenario)
        {
            ...
            else  if (scen is ScenarioScrapCoreChips)
            {
                var convertedScen = scen as ScenarioScrapCoreChips;
        ...
        public override bool UpdateScenarioParams(string scenarioName, Dictionary<string, string> param)
        {
            ...
            switch (scenario)
            {
                ...
                case EN_SCENARIO.SCENARIO_SCRAP_CORE_CHIP:
                    {
                        if (false == param.TryGetValue(ScrapInfoKeys.KeyParamScrapInfo, out var info) ||
                            string.IsNullOrWhiteSpace(info))
                            return false;

                        if (false == param.TryGetValue(ScrapInfoKeys.KeyParamLotId, out var lotId))
                            return false;

                        if (false == param.TryGetValue(ScrapInfoKeys.KeyParamWaferId, out var waferId))
                            return false;

                        if (false == TryParseScrapCoreInfos(param, info, out var scrapCoreInfos))
                            return false;

                        const int IndexOfQty = 2;
                        const int IndexOfInfo = 3;
                        ...
                        Queue<List<string>> infosToUpdate = new Queue<List<string>>();

                        foreach (var scrapCoreInfo in scrapCoreInfos)
                        {
                            variablesToUpdate[IndexOfQty] = scrapCoreInfo.Qty;
                            variablesToUpdate[IndexOfInfo] = scrapCoreInfo.Info;

                            infosToUpdate.Enqueue(new List<string>(variablesToUpdate));
                        }

                        ScenarioList[scenario].UpdateParamValues(
                            new ScenarioScrapCoreChipsParamValues(infosToUpdate));
                ...
                case EN_SCENARIO.SCENARIO_REQ_RECIPE_DOWNLOAD:
                    {
                        ...
                        var paramToSend = new Dictionary<string, string>
                        {
                            ...
                            [RecipeHandlingKeys.KeyRecipeBody] = string.Empty,
                        };

                        param.Remove(RecipeHandlingKeys.KeyUseCommunicationToPM);
                        ScenarioList[scenario].UpdateParamValues(new EFEM.CustomizedByProcessType.PWA500Common.RecipeHandlingRequestParamValues(NameOfClient, MessagesToSend.RequestDownloadRecipe.ToString(),
                ...
                case EN_SCENARIO.SCENARIO_REQ_RECIPE_UPLOAD:
                    {
                        ...
                        param.Remove(RecipeHandlingKeys.KeyUseCommunicationToPM);
                        ScenarioList[scenario].UpdateParamValues(new EFEM.CustomizedByProcessType.PWA500Common.RecipeHandlingRequestParamValues(NameOfClient, MessagesToSend.RequestUploadRecipe.ToString(),
                            paramToSend, useCommunication,
                ...
                case EN_SCENARIO.SCENARIO_REQ_LOT_ID_MERGE_AND_CHANGE_BIN_3:
                    {
                        ...
                        else
                        {
                                    ...
                                    default:
                                        {
                                            ...
                                            else if (item.Key.Equals(SlotMappingKeys.KeyParamWaferQty))
                                            {
                                                waferQty = item.Value;
                                            }
                                        }
                            ...
                            // 2025.05.08. jhlim [ADD] 슬롯매핑과 같은 Report Id를 쓰고 있기 때문에 LotIdChange도 WaferQty 추가됨 -> 고객사 요청에 의해 추후 Report가 분리될 수도 있음
                            changeData.Add(waferQty);
                ...
                case EN_SCENARIO.SCENARIO_UPLOAD_BIN_SCRAP_INFO:
                    {
                        ScenarioList[scenario].UpdateParamValues(new ClientToClientCommunicationParamValues(
                            NameOfClient,
                            MessagesToSend.RequestUploadBinScrapInfo.ToString(),
                            param));
                    }
                    break;
        ...
        public override bool RemoteCommandReceived(string rcmdName, string[] cpNames, string[] cpValues, ref long[] results)
        {
            ...
            else
            {
                ...
                {
                    if (false == IsScenarioRunning(item.Key))
                        continue;
                    ...
                    else if (item.Value is ScenarioScrapCoreChips)
                    {
                        var lotInfoScenario = item.Value as ScenarioScrapCoreChips;
                        if (lotInfoScenario.EventId.Equals(ceid))
                        {
                            item.Value.UpdatePermission(permission);
                            return true;
                    ...
                    else if (item.Value is EFEM.CustomizedByProcessType.PWA500Common.ScenarioRecipeHandlingRequest)
                    {
                        var eventScenario = item.Value as EFEM.CustomizedByProcessType.PWA500Common.ScenarioRecipeHandlingRequest;
                        if (eventScenario.EventId.Equals(ceid))
                        {
                            item.Value.UpdatePermission(permission);
                            return true;
        ...
        public override bool ClientToClientMessageReceived(string deviceName, string messageName, string sendingType, string scenarioName, string[] contentNames, string[] messages, EN_MESSAGE_RESULT result, ref bool useLogging)
        {
            ...
            requestOnlyMessage |= (messageTypeToReceive.Equals(MessagesToReceive.RequestUploadPBIData));
            ...
            Dictionary<string, string> resultData)
        {
            ...
            _functionsForPWA500.ExecuteAfterScenarioCompletion(
                request.Scenario,
                ...
                case MessagesToReceive.RequestStartDetaching:
                    {
                        ...
                        //substrate.SetProcessingStatus(ProcessingStates.InProcess);
                        ...
                        // 2025.03.26. jhlim [ADD] 파트 정보가 다른 빈 웨이퍼가 있는지 검색한다.
                        if (HasDifferentPartInfoWithBinWafer(lotId, partId) && false == UseCoreMapHandlingOnly)
                        {
                            Dictionary<string, string> messageContentToSend = new Dictionary<string, string>
                            {
                                [ResultKeys.KeyResult] = EN_MESSAGE_RESULT.NG.ToString(),
                                [ResultKeys.KeyDescription] = string.Format("Different Part Id : {0}", partId)
                            };
                        ...
                        Dictionary<string, string> scenarioParam = new Dictionary<string, string>
                        {
                            ...
                            [DetachingKeys.KeyParamPortId] = EquipmentInfo.GetPortName(portId),
                        ...
                        return ExecuteSimpleScenarioAndSendClientMessage(EN_SCENARIO.SCENARIO_CORE_WAFER_DETACH_START, scenarioParam, nameOfEq, MessagesToSend.ResponseStartDetaching.ToString());
                        #endregion
                    }
                ...
                case MessagesToReceive.RequestFinishDetaching:
                    {
                        ...
                        return ExecuteSimpleScenarioAndSendClientMessage(EN_SCENARIO.SCENARIO_CORE_WAFER_DETACH_END, scenarioParam, nameOfEq, MessagesToSend.ResponseFinishDetaching.ToString());
                ...
                case MessagesToReceive.RequestStartSorting:
                    {
                        ...
                        // 2025.03.26. jhlim [ADD] 코어의 파트 정보를 Bin Wafer에 적용
                        SetCorePartInfoToBinWafer(ref substrate, out string coreLotId, out string corePartId);
                        ...
                        _substrateManager.SetAttributeByKey(substrate.UniqueKey, PWA500SubstrateAttributes.SubstrateType, subType);
                        ...
                        //{
                        //    [PWA500SubstrateAttributes.SubstrateType] = subType,
                ...
                case MessagesToReceive.RequestUploadCoreFile:
                    {
                        ...
                        string substrateKey = string.Empty, scrapQty = string.Empty, scrapInfo = string.Empty;
                        if (messagePairs.TryGetValue(ScrapInfoKeys.KeyScrapQty, out scrapQty) &&
                            messagePairs.TryGetValue(ScrapInfoKeys.KeyScrapData, out scrapInfo))
                        {
                            
                        }

                        bool useEventHandling = !UseCoreMapHandlingOnly;
                        return ExecuteScenarioToWorkEnd(
                            nameOfEq, 
                            substrateName, 
                            ringId, 
                            chipQty, 
        ...
        private bool ParseMessages(string nameOfEq, MessagesToReceive messageName, string scenarioName, Dictionary<string, string> messagePairs, EN_MESSAGE_RESULT result, ref bool useLogging)
        {
            switch (messageName)
            {
                ...
                case MessagesToReceive.RequestUpdateTraceData:
                    {
                        ...
                        #region
                        //const string variableName = "SUPPLY_PITCH_WAFER_ID";
                        //if (messagePairs.TryGetValue(variableName, out var name) && string.IsNullOrEmpty(name))
                        //{
                        //    var pmName = _processModuleGroup.GetProcessModuleName(ProcessModuleIndex);
                        ...
                        //        {
                        //            if (item.ProcessingStatus == ProcessingStates.InProcess)
                        //            {
                        //                name = item.Name;
                        //                break;
                        //            }
                        ...
                        //    messagePairs[variableName] = name;
                        //}
                ...
                case MessagesToReceive.ResponseUploadBinScrapInfo:
                    {
                        bool scenarioPermission = true;
                        // TODO : 이렇게하면 데이터가 안 들어오는 경우가 생김
                        string substrateName = string.Empty, backupRingId = string.Empty, scrapQtyString = string.Empty, scrapData = string.Empty, userId = string.Empty;
                        if (false == messagePairs.TryGetValue(ResultKeys.KeyResult, out string resultFromClient) ||
                            false == messagePairs.TryGetValue(ResultKeys.KeyDescription, out _) ||
                            false == messagePairs.TryGetValue(ScrapInfoKeys.KeySubstrateName, out substrateName) ||
                            false == messagePairs.TryGetValue(ScrapInfoKeys.KeyBackUpRingId, out backupRingId) ||
                            false == messagePairs.TryGetValue(ScrapInfoKeys.KeyScrapQty, out scrapQtyString) ||
                            false == messagePairs.TryGetValue(ScrapInfoKeys.KeyScrapData, out scrapData) ||
                            false == messagePairs.TryGetValue(ScrapInfoKeys.KeyUserId, out userId))
                            scenarioPermission = false;


                        #region <Find Substrate>
                        string description = null;
                        if (false == _substrateManager.GetSubstrateByKey(backupRingId, out var substrate) ||
                            false == _functionsForPWA500.FindSubstrateByNameOrRingIdAtProcessModule(
                            substrateName,
                            backupRingId,
                            out substrate,
                            out description))
                        {
                            WriteLog(description ?? "Cannot find substrate by name or key");
                            scenarioPermission = false;
                        }
                        #endregion </Find Substrate>

                        // 아래는 로봇에서 발생하기 때문에 제거한다.
                        //string lotId = substrate.LotId;
                        //string ringId = substrate.GetAttribute(PWA500SubstrateAttributes.RingId);
                        //Dictionary<string, string> scenarioParam = null;
                        //if (scenarioPermission &&
                        //    false == ScenarioParameterBuilder.MakeScenarioParamToScrapInfo(
                        //        false,
                        //        lotId,
                        //        ringId,
                        //        scrapQtyString, 
                        ...
                        var currentScenario = EN_SCENARIO.SCENARIO_UPLOAD_BIN_SCRAP_INFO;
                        if (IsScenarioRunning(currentScenario))
                        {
                            _functionsForPWA500.CreateScrapInfoForBin(scrapData, scrapQtyString, userId);

                            ScenarioList[currentScenario].UpdatePermission(scenarioPermission);
                            return true;
                        }

                        //EnqueueScenario(
                        //    EN_SCENARIO.SCENARIO_SCRAP_BIN_CHIP,
                        //    scenarioParam, null);
                ...
                case MessagesToReceive.RequestMoveMaterial:
                    {
                        #region
                        // Vid Update만 필요 -> 고객사 요청
                        if (false == messagePairs.TryGetValue(EESKeys.KeyLocation, out string locationName))
                        {
                            WriteLog("Invalid Location Name");
                            return false;
                        }
                        return UpdateVariablesForMaterialMovementInProcessModule(locationName, true);
                        #endregion
                    }

                case MessagesToReceive.RequestMaterialMoved:
                    {
                        #region
                        // Vid Update만 필요 -> 고객사 요청
                        if (false == messagePairs.TryGetValue(EESKeys.KeyLocation, out string locationName))
                        ...
                        return UpdateVariablesForMaterialMovementInProcessModule(locationName, false);
                        #endregion
                    }
                ...
                case MessagesToReceive.RequestFinishPicking:
                    {
                        #region
                        useLogging = false;//System.Diagnostics.Debugger.IsAttached;
                        // 이벤트 발생 필요
                        // SubstrateName
                        // RingId
                        // BinCode
                        ...
                        EnqueueScenario(EN_SCENARIO.SCENARIO_PICK_UP_END, _finishPickingParams);
                ...
                case MessagesToReceive.RequestFinishPlacing:
                    {
                        ...
                        if (false == MakeScenarioParamToPickAndPlace(messagePairs, false, ref _finishPlacingParams))
                            return false;

                        EnqueueScenario(EN_SCENARIO.SCENARIO_PLACE_END, _finishPlacingParams);

                        return true;
                        #endregion
                    }
                    break;
                case MessagesToReceive.RequestUploadPBIData:
                    {
                        useLogging = false;

                        if (false == TryApplyPbiWorkResultFromPM(messagePairs, _pbiWorkResultValues))
                        {
                            return false;
                        }

                        EnqueueScenario(EN_SCENARIO.SCENARIO_UPLOAD_WORK_RESULT, CreatePbiWorkResultParamSnapshot());
        ...
        private Dictionary<string, string> CreatePbiWorkResultParamSnapshot()
        {
            var result = new Dictionary<string, string>(
                PbiWorkResultKeys.Length,
                StringComparer.Ordinal);

            for (int i = 0; i < PbiWorkResultKeys.Length; ++i)
            {
                result.Add(PbiWorkResultKeys[i], _pbiWorkResultValues[i]);
            }

            return result;
        }
        private static bool TryApplyPbiWorkResultFromPM(
            Dictionary<string, string> receivedMessage,
            string[] targetValues)
        {
            ...
            foreach (KeyValuePair<string, string> item in receivedMessage)
            {
                int index;
                if (PbiWorkResultIndexByKey.TryGetValue(item.Key, out index))
                {
                    targetValues[index] = item.Value ?? string.Empty;
                }
            }

            return true;
        }
        private static Dictionary<string, int> CreatePbiWorkResultIndexByKey()
        {
            ...
            for (int i = 0; i < PbiWorkResultKeys.Length; ++i)
            {
                result.Add(PbiWorkResultKeys[i], i);
            }

            return result;
        }

        private void InitWorkResultData()
        {
            ResetPbiWorkResultValues();
        }

        private void ResetPbiWorkResultValues()
        {
            Array.Copy(
                PbiWorkResultDefaultValues,
                0,
                _pbiWorkResultValues,
                0,
                PbiWorkResultDefaultValues.Length);
        }

        private bool UpdateVariablesForMaterialMovementInProcessModule(string locationName, bool isStarted)
        {
            if (false == Enum.TryParse(locationName, out MaterialMovingLocationsAtProcessModule loc))
            {
                WriteLog("Invalid Location Name");
                return false;
            }

            long[] statusVariableId = new long[1];
            switch (loc)
            {
                case MaterialMovingLocationsAtProcessModule.SORTING_OUT_BUFFER:
                    {
                        statusVariableId[0] = StatusVariableList[EN_SVID_LIST.BIN_TRANSFERRING_OUT_BUFFER_STATUS.ToString()].Id;
                    }
                    break;
                case MaterialMovingLocationsAtProcessModule.SUPPLY_IN_SHUTTLE:
                    {
                        statusVariableId[0] = StatusVariableList[EN_SVID_LIST.CORE_TRANSFERRING_IN_SHUTTLE_STATUS.ToString()].Id;
                    }
                    break;
                case MaterialMovingLocationsAtProcessModule.SUPPLY_OUT_SHUTTLE:
                    {
                        statusVariableId[0] = StatusVariableList[EN_SVID_LIST.CORE_TRANSFERRING_OUT_SHUTTLE_STATUS.ToString()].Id;
                    }
                    break;
                case MaterialMovingLocationsAtProcessModule.SUPPLY:
                    {
                        statusVariableId[0] = StatusVariableList[EN_SVID_LIST.CORE_TRANSFERRING_STAGE_STATUS.ToString()].Id;
                    }
                    break;
                default:
                    WriteLog("Invalid Location Name");
            ...
            string[] statusVariableValue = new string[1];
            statusVariableValue[0] = isStarted ? "1" : "0";

            UpdateVariable(statusVariableId, statusVariableValue);

            return true;
        }
        private bool MakeScenarioParamToPickAndPlace(Dictionary<string, string> receivedMessageFromPM,
            bool isCore,
            ref Dictionary<string, string> resultParam)
        {
            string ringId = string.Empty, substrateName = string.Empty;
            #region <Check SubstrateName or RingId>
            if (false == receivedMessageFromPM.TryGetValue(EESKeys.KeySubstrateName, out substrateName) &&
                false == receivedMessageFromPM.TryGetValue(EESKeys.KeyRingId, out ringId))
            {
                WriteLog("Does not have substrateName or RingId");
                return false;
            }
            #endregion </Check SubstrateName or RingId>

            #region <BinCode>
            if (false == receivedMessageFromPM.TryGetValue(EESKeys.KeyBinCode, out string binCode))
            {
                WriteLog("Invalid BinCode");
                return false;
            }
            #endregion </BinCode>

            #region <Index>
            if (false == receivedMessageFromPM.TryGetValue(EESKeys.KeyIndexX, out string x) ||
                false == receivedMessageFromPM.TryGetValue(EESKeys.KeyIndexY, out string y))
            {
            ...
            #region <Head>
            if (false == receivedMessageFromPM.TryGetValue(EESKeys.KeyHead, out string headNum))
            {
                WriteLog("Invalid Head Number");
                return false;
            }
            #endregion </Head>
            ...
            string coreLotId, corePartId;
            if (false == isCore)
            {
                coreLotId = substrate.GetAttribute(PWA500SubstrateAttributes.CoreLotId);
                corePartId = substrate.GetAttribute(PWA500SubstrateAttributes.CorePartId);
            }
            else
            {
                coreLotId = substrate.LotId;
                corePartId = substrate.GetAttribute(PWA500SubstrateAttributes.PartId);
            }

            if (string.IsNullOrEmpty(coreLotId) &&
                string.IsNullOrEmpty(corePartId))
            {
                WriteLog("Invalid Core Lot and Part Id");
                return false;
            }

            if (resultParam == null)
            {
                resultParam = new Dictionary<string, string>();
            }
            else
            {
                resultParam.Clear();
            ...
            resultParam[EESKeys.KeyLotId] = coreLotId;
            resultParam[EESKeys.KeyPartId] = corePartId;
            resultParam[EESKeys.KeyParamBinType] = binCode;
            resultParam[EESKeys.KeyParamWorkIndexX] = x;
            resultParam[EESKeys.KeyParamWorkIndexY] = y;
            resultParam[EESKeys.KeyParamWorkingPickerNum] = headNum;

            if (isCore)
            {
                if (false == _traceDataProvider.TryGetValueFromId(StatusVariableIdForESDAtStage, out var esdValue))
                {
                    esdValue = "0";   
                }
                resultParam[EESKeys.KeyParamESDSensor04] = esdValue;
            }

            return true;
        }

        private void SetCorePartInfoToBinWafer(ref Substrate binSubstrate, out string coreLotId, out string corePartId)
        {
            coreLotId = string.Empty; corePartId = string.Empty;
            ...
            if (_substrateManager.GetSubstratesAtProcessModule(pmName, ref substrates))
            {
                foreach (var item in substrates)
                {
                    var subTypeToString = item.GetAttribute(PWA500SubstrateAttributes.SubstrateType);
                    if (false == Enum.TryParse(subTypeToString, out SubstrateType substrateType))
                        continue;
                    if (false == substrateType.Equals(SubstrateType.Core))
                        continue;

                    var processStatus = item.ProcessingStatus;
                    if (processStatus == EFEM.Defines.MaterialTracking.ProcessingStates.InProcess)
                    {
                        coreLotId = item.LotId;
                        corePartId = item.GetAttribute(PWA500SubstrateAttributes.PartId);

                        _substrateManager.SetAttributeByKey(binSubstrate.UniqueKey, PWA500SubstrateAttributes.CoreLotId, coreLotId);
                        _substrateManager.SetAttributeByKey(binSubstrate.UniqueKey, PWA500SubstrateAttributes.CorePartId, corePartId);
                        _substrateManager.SaveDataByKey(binSubstrate.UniqueKey);

                        //_substrateManager.SetAttributesByKey(binSubstrate.UniqueKey, new Dictionary<string, string>
                        //{
                        //    [PWA500SubstrateAttributes.CoreLotId] = coreLotId,
                        //    [PWA500SubstrateAttributes.CorePartId] = corePartId,

                        //});

                        WriteLog(string.Format("Set Core Part Id -> Bin Wafer : {0}, PartId : {1}", binSubstrate.Name, corePartId));
            ...
            // 2. pm에 있는 자재 탐색 실패 시(자재가 pm에 없을 시) 캐리어 정보로 탐색
            for (int i = 0; i < _loadPortManager.Count; ++i)
            {
                ...
                if (_carrierServer.GetCarrierAccessingStatus(portId).Equals(EFEM.Defines.LoadPort.CarrierAccessStates.InAccessed))
                {
                    corePartId = _carrierServer.GetAttribute(portId, PWA500CarrierAttributes.KeyPartId);
                    coreLotId = _carrierServer.GetCarrierLotId(portId);
        ...
        private bool HasDifferentPartInfoWithBinWafer(string coreLotId, string targetPartId)
        {
            var pmName = _processModuleGroup.GetProcessModuleName(ProcessModuleIndex);
            List<Substrate> substrates = new List<Substrate>();
            if (_substrateManager.GetSubstratesAtProcessModule(pmName, ref substrates))
            {
                foreach (var item in substrates)
                {
                    ...
                    if (processStatus == EFEM.Defines.MaterialTracking.ProcessingStates.InProcess)
                    {
                        var partId = item.GetAttribute(PWA500SubstrateAttributes.CorePartId);
                        if (string.IsNullOrEmpty(partId))
                        {
                            _substrateManager.SetAttributeByKey(item.UniqueKey, PWA500SubstrateAttributes.CoreLotId, coreLotId);
                            _substrateManager.SetAttributeByKey(item.UniqueKey, PWA500SubstrateAttributes.CorePartId, targetPartId);
                            _substrateManager.SaveDataByKey(item.UniqueKey);

                            //_substrateManager.SetAttributesByKey(item.UniqueKey, new Dictionary<string, string>
                            //{
                            //    [PWA500SubstrateAttributes.CoreLotId] = coreLotId,
                            //    [PWA500SubstrateAttributes.CorePartId] = targetPartId,
                            //});

                            WriteLog(string.Format("Part Id is empty at bin wafer({0}). Then try setting part Id : {1}", item.Name, targetPartId));
                        }
                        else
                        {
                            WriteLog(string.Format("Check Part Id -> Core : {0}, Bin : {1}", targetPartId, partId));
                            if (false == targetPartId.Equals(partId))
                            {
                                return false;
                            }
                        }
        ...
        private bool TryParseScrapCoreInfos(
            Dictionary<string, string> param,
            string scrapInfo,
            out List<ScrapCoreInfo> scrapCoreInfos)
        {
            scrapCoreInfos = new List<ScrapCoreInfo>();

            if (string.IsNullOrWhiteSpace(scrapInfo))
                return false;

            var scrapDataList = scrapInfo.Split(',');

            foreach (var item in scrapDataList)
            {
                var data = item.Split(':');
                ...
                scrapCoreInfos.Add(new ScrapCoreInfo(info, qty));
            }

            if (scrapCoreInfos.Count > 0)
                return true;

            if (scrapInfo.IndexOf(',') >= 0 || scrapInfo.IndexOf(':') >= 0)
                return false;

            if (false == param.TryGetValue(ScrapInfoKeys.KeyParamScrapQty, out var scrapQty))
                return false;

            if (string.IsNullOrWhiteSpace(scrapQty))
                return false;

            scrapCoreInfos.Add(new ScrapCoreInfo(scrapInfo.Trim(), scrapQty.Trim()));
        ...
        //        Dictionary<string, string> scenarioParam = new Dictionary<string, string>()
        //        {
        //            [AssignSubstrateIdKeys.KeyParamLotId] = binSubstrate.LotId,
        ...
        //        EnqueueScenarioAsync(EN_SCENARIO.SCENARIO_REQ_BIN_WAFER_ID_ASSIGN, scenarioParam, additionalParams);
        //        return true;
        //    }
        //    else
        //    {
        ...
        //        {
        //            [ResultKeys.KeyResult] = EN_MESSAGE_RESULT.NG.ToString(),
        //            [ResultKeys.KeyDescription] = "Does not have substrate id",
        //        };
            ...
            SubstrateType substrateType, int splitQty, string binCode, string userId)
        {
            ...
            if (false == isSplittedFully)
            {
                if (isFirstSorting)
                {
                    scenario = EN_SCENARIO.SCENARIO_REQ_CORE_CHIP_SPLIT_FIRST;
                }
                else
                {
                    scenario = EN_SCENARIO.SCENARIO_REQ_CORE_CHIP_SPLIT;
                }
            }
            else
            {
                if (isFirstSorting)
                {
                    scenario = EN_SCENARIO.SCENARIO_REQ_CORE_CHIP_FULL_SPLIT_FIRST;
                }
                else
                {
                    scenario = EN_SCENARIO.SCENARIO_REQ_CORE_CHIP_FULL_SPLIT;
                }
            }

            if (_functionsForPWA500.FindSubstrateByNameOrRingIdAtProcessModule(coreSubstrateId, coreSubstrateId, out var coreSubstrate, out _) &&
                _functionsForPWA500.FindSubstrateByNameOrRingIdAtProcessModule(ringId, ringId, out var binSubstrate, out _))
            {
                Dictionary<string, string> scenarioParam = new Dictionary<string, string>()
                {
                    [SplitCoreChipKeys.KeyParamLotId] = coreSubstrate.LotId,
                ...
                _substrateManager.SetAttributeByKey(binSubstrate.UniqueKey, PWA500SubstrateAttributes.BinCode, binCode);
                EnqueueScenario(scenario, scenarioParam, additionalParams);
                return true;
            }
            else
        ...
        private bool ExecuteScenarioToDownloadMapFile(string nameOfEq, string substrateId, string ringId, double waferAngle, string nullBinCode, string userId, bool useEventHandling)
        {
                ...
                _functionsForPWA500.GetSubstrateByName(ringId, out substrate))
            {
                ...
                EnqueueScenario(EN_SCENARIO.SCENARIO_WORK_START, scenarioParams, additionalParams);
                return true;
            }
            else
            {
        ...
        private bool ExecuteScenarioToWorkEnd(
            string nameOfEq, 
            string substrateId, 
            string ringId,
            int chipQty, 
            ...
            bool useEventHandling)
        {
            if (_functionsForPWA500.FindSubstrateByNameOrRingIdAtProcessModule(substrateId, ringId, out var substrate, out _))
            {
                ...
                var additionalParams = new Dictionary<string, string>
                {
                    ...
                    [ScrapInfoKeys.KeyScrapData] = scrapInfo,
                    [ScrapInfoKeys.KeyScrapQty] = scrapQty,
                };
        ...
        //{
        //    EN_SCENARIO scenario = EN_SCENARIO.SCENARIO_BIN_DATA_UPLOAD;
        //    string recipeId = EquipmentInfo.GetRecipeId();

        //    if (_functionsForPWA500.GetSubstrateByName(substrateId, out var substrate) ||
        //        _functionsForPWA500.GetSubstrateByName(ringId, out substrate))
        //    {
        //        string lotId = substrate.LotId;                
        //        int portId, slot;
        ...
        //        string fileName = _functionsForPWA500.GetPMSFileName(lotId, substrateId);
        //        string fullPath = string.Empty;
        //        if (false == ScenarioParameterBuilder.MakePMSFile(lotId, substrateId, fileName, pmsFileBody, ref fullPath))
        //            return false;
