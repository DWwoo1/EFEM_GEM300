namespace FrameOfSystem3.Views.Functional
{
    partial class Form_Calculator
    {
        ...
        private void InitializeComponent()
        {
			...
			this.m_labelPresent = new Sys3Controls.Sys3Label();
			...
			this.m_labelPrevious = new Sys3Controls.Sys3Label();
			this.lbl_PreviousTime = new Sys3Controls.Sys3Label();
			...
			// m_labelPresent
			// 
			this.m_labelPresent.BackGroundColor = System.Drawing.Color.White;
			this.m_labelPresent.BorderStroke = 2;
			this.m_labelPresent.BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.m_labelPresent.Description = "";
			this.m_labelPresent.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_labelPresent.EdgeRadius = 1;
			this.m_labelPresent.ImagePosition = new System.Drawing.Point(0, 0);
			this.m_labelPresent.ImageSize = new System.Drawing.Point(0, 0);
			this.m_labelPresent.LoadImage = null;
			this.m_labelPresent.Location = new System.Drawing.Point(12, 142);
			this.m_labelPresent.MainFont = new System.Drawing.Font("맑은 고딕", 12F, System.Drawing.FontStyle.Bold);
			this.m_labelPresent.MainFontColor = System.Drawing.Color.Black;
			this.m_labelPresent.Name = "m_labelPresent";
			this.m_labelPresent.Size = new System.Drawing.Size(137, 55);
			this.m_labelPresent.SubFont = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			this.m_labelPresent.SubFontColor = System.Drawing.Color.Black;
			this.m_labelPresent.SubText = "PRESENT";
			this.m_labelPresent.TabIndex = 1372;
			this.m_labelPresent.Text = "0";
			this.m_labelPresent.TextAlignMain = Sys3Controls.EN_TEXTALIGN.BOTTOM_RIGHT;
			this.m_labelPresent.TextAlignSub = Sys3Controls.EN_TEXTALIGN.TOP_LEFT;
			this.m_labelPresent.TextAlignUnit = Sys3Controls.EN_TEXTALIGN.BOTTOM_RIGHT;
			this.m_labelPresent.ThemeIndex = 0;
			this.m_labelPresent.UnitAreaRate = 35;
			this.m_labelPresent.UnitFont = new System.Drawing.Font("맑은 고딕", 9.5F, System.Drawing.FontStyle.Bold);
			this.m_labelPresent.UnitFontColor = System.Drawing.Color.Black;
			this.m_labelPresent.UnitPositionVertical = false;
			this.m_labelPresent.UnitText = "mm/s";
			this.m_labelPresent.UseBorder = true;
			this.m_labelPresent.UseEdgeRadius = false;
			this.m_labelPresent.UseImage = false;
			this.m_labelPresent.UseSubFont = true;
			this.m_labelPresent.UseUnitFont = true;
			this.m_labelPresent.DoubleClick += new System.EventHandler(this.Click_Present);
			// 
			// m_labelMin
			// 
			...
			this.m_labelMin.Location = new System.Drawing.Point(12, 298);
			...
			this.m_labelMax.Location = new System.Drawing.Point(12, 359);
			...
			this.m_labelUnit.Location = new System.Drawing.Point(12, 420);
			...
			// m_labelPrevious
			// 
			this.m_labelPrevious.BackGroundColor = System.Drawing.Color.LightCyan;
			this.m_labelPrevious.BorderStroke = 2;
			this.m_labelPrevious.BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.m_labelPrevious.Description = "";
			this.m_labelPrevious.DisabledColor = System.Drawing.Color.DarkGray;
			this.m_labelPrevious.EdgeRadius = 1;
			this.m_labelPrevious.ImagePosition = new System.Drawing.Point(0, 0);
			this.m_labelPrevious.ImageSize = new System.Drawing.Point(0, 0);
			this.m_labelPrevious.LoadImage = null;
			this.m_labelPrevious.Location = new System.Drawing.Point(12, 219);
			this.m_labelPrevious.MainFont = new System.Drawing.Font("맑은 고딕", 12F, System.Drawing.FontStyle.Bold);
			this.m_labelPrevious.MainFontColor = System.Drawing.Color.Black;
			this.m_labelPrevious.Name = "m_labelPrevious";
			this.m_labelPrevious.Size = new System.Drawing.Size(137, 55);
			this.m_labelPrevious.SubFont = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			this.m_labelPrevious.SubFontColor = System.Drawing.Color.Black;
			this.m_labelPrevious.SubText = "PREVIOUS";
			this.m_labelPrevious.TabIndex = 1375;
			this.m_labelPrevious.Text = "0";
			this.m_labelPrevious.TextAlignMain = Sys3Controls.EN_TEXTALIGN.BOTTOM_RIGHT;
			this.m_labelPrevious.TextAlignSub = Sys3Controls.EN_TEXTALIGN.TOP_LEFT;
			this.m_labelPrevious.TextAlignUnit = Sys3Controls.EN_TEXTALIGN.BOTTOM_RIGHT;
			this.m_labelPrevious.ThemeIndex = 0;
			this.m_labelPrevious.UnitAreaRate = 35;
			this.m_labelPrevious.UnitFont = new System.Drawing.Font("맑은 고딕", 9.5F, System.Drawing.FontStyle.Bold);
			this.m_labelPrevious.UnitFontColor = System.Drawing.Color.Black;
			this.m_labelPrevious.UnitPositionVertical = false;
			this.m_labelPrevious.UnitText = "mm/s";
			this.m_labelPrevious.UseBorder = true;
			this.m_labelPrevious.UseEdgeRadius = false;
			this.m_labelPrevious.UseImage = false;
			this.m_labelPrevious.UseSubFont = true;
			this.m_labelPrevious.UseUnitFont = true;
			this.m_labelPrevious.DoubleClick += new System.EventHandler(this.Click_Previous);
			// 
			// lbl_PreviousTime
			// 
			this.lbl_PreviousTime.BackGroundColor = System.Drawing.Color.White;
			this.lbl_PreviousTime.BorderStroke = 2;
			this.lbl_PreviousTime.BorderStyle = System.Windows.Forms.ButtonBorderStyle.Solid;
			this.lbl_PreviousTime.Description = "";
			this.lbl_PreviousTime.DisabledColor = System.Drawing.Color.DarkGray;
			this.lbl_PreviousTime.EdgeRadius = 1;
			this.lbl_PreviousTime.ImagePosition = new System.Drawing.Point(0, 0);
			this.lbl_PreviousTime.ImageSize = new System.Drawing.Point(0, 0);
			this.lbl_PreviousTime.LoadImage = null;
			this.lbl_PreviousTime.Location = new System.Drawing.Point(12, 198);
			this.lbl_PreviousTime.MainFont = new System.Drawing.Font("맑은 고딕", 9F, System.Drawing.FontStyle.Bold);
			this.lbl_PreviousTime.MainFontColor = System.Drawing.Color.Black;
			this.lbl_PreviousTime.Margin = new System.Windows.Forms.Padding(1, 1, 0, 0);
			this.lbl_PreviousTime.Name = "lbl_PreviousTime";
			this.lbl_PreviousTime.Size = new System.Drawing.Size(137, 20);
			this.lbl_PreviousTime.SubFont = new System.Drawing.Font("맑은 고딕", 10F, System.Drawing.FontStyle.Bold);
			this.lbl_PreviousTime.SubFontColor = System.Drawing.Color.Black;
			this.lbl_PreviousTime.SubText = "";
			this.lbl_PreviousTime.TabIndex = 1376;
			this.lbl_PreviousTime.Text = "yy-MM-dd HH:mm:ss";
			this.lbl_PreviousTime.TextAlignMain = Sys3Controls.EN_TEXTALIGN.MIDDLE_RIGHT;
			this.lbl_PreviousTime.TextAlignSub = Sys3Controls.EN_TEXTALIGN.TOP_LEFT;
			this.lbl_PreviousTime.TextAlignUnit = Sys3Controls.EN_TEXTALIGN.BOTTOM_RIGHT;
			this.lbl_PreviousTime.ThemeIndex = 0;
			this.lbl_PreviousTime.UnitAreaRate = 35;
			this.lbl_PreviousTime.UnitFont = new System.Drawing.Font("맑은 고딕", 9.5F, System.Drawing.FontStyle.Bold);
			this.lbl_PreviousTime.UnitFontColor = System.Drawing.Color.Black;
			this.lbl_PreviousTime.UnitPositionVertical = false;
			this.lbl_PreviousTime.UnitText = "";
			this.lbl_PreviousTime.UseBorder = true;
			this.lbl_PreviousTime.UseEdgeRadius = false;
			this.lbl_PreviousTime.UseImage = false;
			this.lbl_PreviousTime.UseSubFont = false;
			this.lbl_PreviousTime.UseUnitFont = false;
			// 
			// sys3button16
			// 
			...
			this.Controls.Add(this.lbl_PreviousTime);
			this.Controls.Add(this.m_labelPrevious);
			...
			this.Controls.Add(this.m_labelPresent);
		...
		private Sys3Controls.Sys3Label m_labelPresent;
		...
		private Sys3Controls.Sys3Label m_labelPrevious;
		private Sys3Controls.Sys3Label lbl_PreviousTime;
	}
}
