...
{
    public class UpdateParameterParam : ScenarioParamValues
    {
        public UpdateParameterParam(List<string> values) : base(values)
        {
        }
    }

    public class UpdateParameterScenario : ScenarioBaseClass
    {
        #region <Constructor>
		public UpdateParameterScenario(List<long> variableIds = null)
